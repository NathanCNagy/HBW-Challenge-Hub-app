    ...
    <div className="w-full flex flex-col items-center">
      ...
      <div className="w-full max-w-7xl mx-auto px-4 py-4 mb-4 flex flex-col sm:flex-row items-center justify-between border border-[#002246]/60 bg-[#000f1f]/80 backdrop-blur-md rounded-2xl gap-4">
        <div className="flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-[#0285ff] flex items-center justify-center text-white font-serif font-bold text-xl tracking-wider shadow-[0_0_15px_rgba(2,133,255,0.4)]">
            H
          </div>
          <div>
            <h1 className="text-xl font-serif text-white font-semibold tracking-tight flex items-center gap-2">
      ...
      <div className="w-full max-w-7xl mx-auto flex flex-col lg:flex-row justify-center items-center lg:items-start gap-8 min-h-[750px] py-4">
        ...
        <div className="relative w-[390px] h-[820px] bg-black rounded-[50px] p-3.5 shadow-[0_25px_60px_-15px_rgba(2,133,255,0.15)] border-4 border-neutral-900 flex flex-col items-center shrink-0 transition-all duration-300">
          ...
          <div className="w-full h-full bg-[#000814] rounded-[38px] overflow-hidden relative flex flex-col border border-neutral-950">
            {/* Simulated Mobile Status bar */}
            <div className="pt-3 px-6 pb-2 bg-[#000814] text-white flex items-center justify-between text-2xs font-sans font-semibold tracking-wide select-none">
              <span>09:41</span>
              <div className="flex items-center gap-1.5">
                <span className="text-2xs font-mono">5G</span>
                <div className="w-5 h-2.5 bg-slate-900 rounded-sm p-0.5 border border-slate-800 flex items-center justify-start">
            ...
            <div className="flex-1 w-full overflow-y-auto overflow-x-hidden relative flex flex-col bg-[#000814]">
              {children}
            </div>

            {/* Simulated iOS home gesture pill */}
            <div className="w-full h-5 bg-[#000814] flex items-center justify-center shrink-0 pb-1.5 z-20">
